...
public class LibelloValence extends ConstructorJCDecaultVelibLikeStationManager {//ConstructorSmoove {

	//String url = "http://www.velomagg.com/10003.html";

	// public final static String WS_VELIB_ALL_STATIONS_URL = "http://xirgonium.free.fr/testxml/carto.xml";
	private final static String	WS_ALL_STATIONS_URL		= " http://www.velo-libelo.fr/service/carto";

	// ---- Add the station ID at the end of the URL to get data from Velib'
	private final static String	WS_STATION_DETAIL_URL	= "http://www.velo-libelo.fr/service/stationdetails/";

	public LibelloValence() {
	}

	public LibelloValence(Context launched) {
		super(launched);
	}
