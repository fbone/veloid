package com.xirgonium.android.widget;
...
public class VeloidWidgetProvider extends AppWidgetProvider {
  ...
  public void onEnabled(Context context) {
    ...
    // pm.setComponentEnabledSetting(new ComponentName("com.example.android.apis", ".appwidget.ExampleBroadcastReceiver"), PackageManager.COMPONENT_ENABLED_STATE_ENABLED,
  ...
  static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
    ...
    views.setTextViewText(R.id.TextView01, "BANANE");
    appWidgetManager.updateAppWidget(appWidgetId, views);
  }
